...
DAPP_NAME="coin-toss" docker compose --env-file env.sepolia -f deploy-testnet.yml up #deploy to cartesi factory
DAPP_NAME="coin-toss" docker compose --env-file env.<network> -f deploy-testnet.yml down -v #stop docker after finish
DAPP_NAME="trust-and-teach" docker compose --env-file env.sepolia -f docker-compose-testnet.yml up
DAPP_NAME="coin-toss" docker compose --env-file env.<network> -f docker-compose-testnet.yml -f docker-compose-host-testnet.yml up # host mode
